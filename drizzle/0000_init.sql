...
CREATE UNIQUE INDEX "columns_board_position_uq" ON "columns" USING btree ("board_id","position");--> statement-breakpoint
CREATE UNIQUE INDEX "tasks_column_position_uq" ON "tasks" USING btree ("column_id","position");--> statement-breakpoint
